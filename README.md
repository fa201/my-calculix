...
This is not a fork of [Calculix](http://calculix.de/), rather the place where I share some of my:
- help files
- tips
- configuration files
- examples
...
This is related to CrunchiX (CCX) and Graphix (CGX).
